param([ValidateSet('lamprey-preflight', 'lamprey-smoke', 'lamprey-acceptance', 'hermes-preflight', 'hermes-acceptance', 'native', 'imports', 'inspect')][string]$Mode = 'lamprey-acceptance', [ValidateSet('metadata','hermes','hermes-help','desktop','build','evidence')][string]$Section = 'metadata')
