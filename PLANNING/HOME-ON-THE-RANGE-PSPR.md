...
Execution checkpoint (2026-09-06): HOTR-16 and HOTR-17 are published with exact hosted Windows gates passed. HOTR-17 main is `af906f7e06378f5988ef3b334f36cf88cc79d9cf`. HOTR-18 complete local gate `HOTR-18-91104-1788724083416365000` passed on 85 source/input hashes, including actual installed Chrome, temporary-credential persistence checks and the frozen retrieval regression. Fresh independent review returned ship with no findings; accepted implementation is `420bf447f5b62af20810cf30c240469e44de4deb`. Authorized main publication and exact hosted verification follow; final published-head evidence is reported externally to avoid circular SHA bookkeeping. Latest owner direction is to stop after HOTR-18 publication and standby until further instruction; HOTR-19 implementation has not started. Remaining HOTR-12/Lamprey scope stays deferred. Earlier checkpoints below are history.
